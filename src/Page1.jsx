    ...
    <div className="container-fluid  d-flex flex-column min-vh-100">
      ...
      >
        <div className="row mt-5 pt-3">
          <div className="col-lg-6 border border-2 border-light rounded-3">
            <img
              src={Product1}
              className="img-fluid haitianSubPageImage"
              alt="MA-2100-V/H product image"
            />
          </div>
          <div className="col-lg-6 border border-2 border-light rounded-3 mt-2 mt-lg-0 p-lg-1 haitianSubPageColor">
            <div className="col-11 "> 
            <h1 className=" text-center mt-1">Application</h1>
            </div>
            <div className="col-12 d-flex justify-content-center mt-3">
              <div className="col-6 col-md-3 col-lg-3 haitianSubpageLabel">
                <p>Machine Type</p>
                <p>Applicaition</p>
                <p>Shot weight</p>
                <p>Product size</p>
              ...
              <div className="col-6 col-md-3 col-lg-3 haitianSubpageValue ">
                <p>MA2100V/h</p>
                <p>0.5L Bowl</p>
                <p>135gr</p>
                <p>0.5L</p>
      ...
      >
        <div className="row mt-5">
          <div className="col-xl-6 border border-2 border-light rounded-3 d-flex justify-content-center">
            <img
              src={Product1}
              className="img-fluid haitianSubPageImage p-2"
              alt="MA-2100-V/H product image"
            />
          </div>
